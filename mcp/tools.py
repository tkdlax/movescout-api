...
TOOLS: list[Tool] = [
    _tool(
        ...
        (
            ...
            "P11 capture evidence (packets 00-38): supports filters[] array for per-column filtering. "
            ...
            "leadLMP.lmpId, agencyCode, registrationNumber, salesRepName, createdUserName, bookerName (Booking Agent Name), "
            "coordinatorName (Coordinator), modifiedUserName (Modified By), localCarrierId (Local Carrier — UI gap: filter "
            "submits but sampled blank cells produce totalCount 0; allowlisted for completeness). "
            ...
            "leadNonConforming.nonConformingFlag (true), leadMoSys.canadaGovMove (true), createdSource (e.g. 5), "
            "mobileSyncStatusId (e.g. 204), lostReasonId (e.g. 13), leadLMP.transferTypeId (e.g. 1063). "
            ...
            "leadMoveDate.loadToDate, leadMoveDate.expectedDeliverDate, leadMoveDate.scheduledDate (Appt Created Date). "
        ...
        ),
        {
            ...
            "filters": {
                ...
                "description": (
                    ...
                    "salesRepName, createdUserName, bookerName, coordinatorName, modifiedUserName, "
                    "localCarrierId (UI gap: blank cells → totalCount 0). "
                    ...
                    "createdSource (int), mobileSyncStatusId (int), lostReasonId (int), leadLMP.transferTypeId (int). "
                    "DATE PRESET fields (eq with {id, value}): assignedDate, creationTime, leadMoveDate.loadFromDate, "
                    "primaryLeadEstimate.effectiveDate, primaryLeadEstimate.validThruDate, lastModificationTime, "
                    "leadMoveDate.loadToDate, leadMoveDate.expectedDeliverDate, leadMoveDate.scheduledDate. "
